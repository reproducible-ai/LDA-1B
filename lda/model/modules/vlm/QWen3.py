...
_ACTION_TOKEN_MAX = 153716 # here only for fast_tokenizer, see lda/model/modules/vlm/tools/add_qwen_special_tokens/README.md
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        revision = qwenvl_config.get("revision")
